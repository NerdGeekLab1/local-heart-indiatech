...
export const communityReels: CommunityReel[] = [
  { id: "reel-1", travelerName: "Emily R.", country: "USA", hostName: "Ravi", city: "Jaipur", caption: "Rooftop chai with the best views in the Pink City 🌅✨", hashtags: ["#JaipurVibes", "#IndiaTravel", "#RoamYoo", "#RooftopMoments", "#PinkCity"], likes: 2847, comments: 134, thumbnail: hostRavi, duration: "0:28", featured: true },
  { id: "reel-2", travelerName: "Hans K.", country: "Germany", hostName: "Arjun", city: "Varanasi", caption: "Sunrise on the Ganges hits different when you have a spiritual guide 🕉️🌄", hashtags: ["#VaranasiMagic", "#GangaAarti", "#SpiritualJourney", "#RoamYoo"], likes: 3291, comments: 189, thumbnail: hostArjun, duration: "0:45", featured: true },
  { id: "reel-3", travelerName: "Akiko T.", country: "Japan", hostName: "Priya", city: "Alleppey", caption: "Grandmother's kitchen > Any 5-star restaurant 🍛❤️", hashtags: ["#KeralaFood", "#HomeCooking", "#Backwaters", "#RoamYoo", "#FoodLove"], likes: 4120, comments: 267, thumbnail: hostPriya, duration: "0:52", featured: true },
  { id: "reel-4", travelerName: "Carlos M.", country: "Brazil", hostName: "Meera", city: "Goa", caption: "Hidden beach + Goan prawn curry = Perfect day 🏖️🦐", hashtags: ["#GoaSecrets", "#HiddenBeach", "#GoanFood", "#RoamYoo", "#BeachLife"], likes: 1893, comments: 98, thumbnail: hostMeera, duration: "0:33" },
  { id: "reel-5", travelerName: "Rachel K.", country: "Canada", hostName: "Deepak", city: "Delhi", caption: "My face when I tried Paranthe Wali Gali for the first time 😱🤤", hashtags: ["#DelhiStreetFood", "#FoodWalk", "#ChandniChowk", "#RoamYoo", "#Foodie"], likes: 5672, comments: 342, thumbnail: hostDeepak, duration: "0:41", featured: true },
  { id: "reel-6", travelerName: "Anna S.", country: "Sweden", hostName: "Sunita", city: "Udaipur", caption: "Miniature painting class with 300-year-old techniques 🎨🏰", hashtags: ["#UdaipurArt", "#CityOfLakes", "#IndianArt", "#RoamYoo", "#CulturalImmersion"], likes: 2156, comments: 127, thumbnail: hostSunita, duration: "0:37" },
  { id: "reel-7", travelerName: "Jake P.", country: "UK", hostName: "Kiran", city: "Mumbai", caption: "Bollywood studio tour + Vada Pav = Mumbai essentials 🎬🍔", hashtags: ["#MumbaiDiaries", "#Bollywood", "#VadaPav", "#RoamYoo", "#CityOfDreams"], likes: 3890, comments: 201, thumbnail: hostKiran, duration: "0:44" },
  { id: "reel-8", travelerName: "Lina M.", country: "France", hostName: "Ravi", city: "Jaipur", caption: "Jumped off a sand dune in the Thar Desert and my soul left my body 🏜️😂", hashtags: ["#DesertSafari", "#TharDesert", "#AdventureTravel", "#RoamYoo", "#DuneBashing"], likes: 6234, comments: 412, thumbnail: expAdventure, duration: "0:29", featured: true },
  { id: "reel-9", travelerName: "Mike T.", country: "Australia", hostName: "Meera", city: "Goa", caption: "First time scuba diving and I'm already addicted 🤿🐠", hashtags: ["#ScubaDiving", "#GoaAdventure", "#UnderwaterWorld", "#RoamYoo"], likes: 2445, comments: 156, thumbnail: expBeach, duration: "0:38" },
  { id: "reel-10", travelerName: "Sophie B.", country: "Netherlands", hostName: "Arjun", city: "Varanasi", caption: "White water rafting on the Ganges — adrenaline like no other 🌊🏄‍♀️", hashtags: ["#RiverRafting", "#Rishikesh", "#AdventureSports", "#RoamYoo"], likes: 4567, comments: 289, thumbnail: expAdventure, duration: "0:50" },
];
...
export const blogPosts: BlogPost[] = [
  {
    ...
    author: "RoamYoo Editorial", authorImage: hostRavi, category: "Travel Guide", tags: ["Beginner", "Planning", "India 101"], date: "2026-03-20", readTime: "12 min", image: expVillage, featured: true,
  },
  {
...
export const travelTips: TravelTip[] = [
  ...
  { id: "tt3", title: "Staying Safe", category: "safety", content: "Book through RoamYoo for verified hosts. Share your itinerary with family. Keep digital copies of all documents. Stay hydrated. Use reputable transport. Trust your instincts.", icon: "🛡️" },
